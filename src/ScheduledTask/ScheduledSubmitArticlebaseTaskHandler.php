...
class ScheduledSubmitArticlebaseTaskHandler extends ScheduledTaskHandler
{
    ...
    {
        return [ScheduledSubmitArticlebaseTask::class];
    }

    public function run(): void
    {
        $this->interfaceController->submitArticlebase(Context::createDefaultContext());
    }
}
